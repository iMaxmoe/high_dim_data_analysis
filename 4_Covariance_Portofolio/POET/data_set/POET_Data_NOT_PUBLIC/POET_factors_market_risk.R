...
C = POETCmin(as.matrix(final_mat), K, thres = set_threshold, 'vad')   #Also takes forever cause of CV
POET_MATRIX = POET(as.matrix(final_mat), K, C, thres = set_threshold, 'vad')
